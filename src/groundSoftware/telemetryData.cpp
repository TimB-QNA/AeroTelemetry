...
telemetryData::telemetryData(){
  proMethod=projection::spherical; // Spherical projection of position data points
}
...
/*!
 * \todo Setup search for correct time here.
 */
void telemetryData::insertPosition(QDateTime time, odPoint pos, bool checkTime){
  telemetryDataPoint tdp;
  tdp.time=time;
  tdp.position=pos;
