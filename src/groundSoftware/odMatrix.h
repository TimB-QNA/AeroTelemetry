 ...
 * and has been reasonably well tested in those uses. This implementation has been
 * copied direct from the openDynamics project (https://github.com/TimB-QNA/openDynamics).
 * Any updates to this class should be merged to that tree as well. This class does not provide
