...
Q_EXPORT_PLUGIN2(gfxRhino3D, gfxRhino3D);

gfxRhino3D::gfxRhino3D(QObject *parent) : QObject(parent){
}

void gfxRhino3D::setParentObject(gfxObject *obj){
  parentObject=obj;
}

QObject* gfxRhino3D::asQObject(){
  return this;
}

QString gfxRhino3D::pluginName(){
  return QString("gfxRhino3D");
}

QString gfxRhino3D::pluginDescription(){
  return QString("Rhino3D Graphics Format Plugin");
}
