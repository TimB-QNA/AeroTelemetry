...
void gfxObject::loadCAD(QString filename){
  int i, layer;
  ON_Color objCol;
...
vtkActor* gfxObject::createActor(const ON_Object *object, double red, double green, double blue){
  ON_Brep *brep;
...
int gfxObject::load3dm(QString inputFile){
  int i, j;
...
int gfxObject::findONLayer(QString LayerName){
  int j;
...
QString gfxObject::convertONstring(ON_wString ONs){
  int j;
  QString line;
  line="";
